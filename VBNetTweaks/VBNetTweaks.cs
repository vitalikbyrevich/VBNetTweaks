...
namespace VBNetTweaks
{
    ...
    public class VBNetTweaks : BaseUnityPlugin
    {
        ...
        private const string ModVersion = "0.4.1.1";
        ...
        private void InitClientConfigs()
        {
            ...
            c_SteamSendRateMaxKB = _clientConfig.BindConfig(steamSection, "MaxRateKB", 1024,
            ...
            c_SteamSendBufferSizeKB = _clientConfig.BindConfig(steamSection, "SendBufferSizeKB", 1024,
            ...
            c_ZDOQueueLimit = _clientConfig.BindConfig(clientSection, "ZDOQueueLimit", 10240,
            ...
            c_PlayerSortBonus = _clientConfig.BindConfig(clientSection, "PlayerSortBonus", 50f, c_ConfigLanguage.Value == Language.Russian 
            ...
            c_StaticSortPenalty = _clientConfig.BindConfig(clientSection, "StaticSortPenalty", 30f, c_ConfigLanguage.Value == Language.Russian
            ...
            c_SmoothPosition = _clientConfig.BindConfig(transformSection, "SmoothPosition", 0.15f,
            ...
            c_MicroThreshold = _clientConfig.BindConfig(transformSection, "MicroThreshold", 0.005f,
            ...
            c_TeleportDistanceThreshold = _clientConfig.BindConfig(transformSection, "TeleportDistanceThreshold", 7.5f,
                c_ConfigLanguage.Value == Language.Russian
            ...
            c_TeleportRotationThreshold = _clientConfig.BindConfig(transformSection, "TeleportRotationThreshold", 50f,
                c_ConfigLanguage.Value == Language.Russian
            ...
            c_MapInterpolationDelay = _clientConfig.BindConfig(mapSection, "InterpolationDelay", 0.65f,
                c_ConfigLanguage.Value == Language.Russian
            ...
            c_MapMaxPredictionTime = _clientConfig.BindConfig(mapSection, "MaxPredictionTime", 0.3f,
                c_ConfigLanguage.Value == Language.Russian
        ...
        private void InitServerConfigs()
        {
           var serverSection = "07 - Server ZDO Settings";
            ...
            c_PeersPerUpdate_S = _clientConfig.BindConfig(serverSection, "PeersPerUpdate", 8, c_ConfigLanguage.Value == Language.Russian 
